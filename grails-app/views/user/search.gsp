		...
		<div>
			...
			<table>
				...
				<tr>
					...
					<s2ui:sortableColumn property='displayName' titleDefault='Display Name'/>
				...
				<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
					...
					<td><g:link action='edit' id='${user.id}'>${uiPropertiesStrategy.getProperty(user, 'displayName')}</g:link></td>
					<td><a href="mailto:${user.email}">${uiPropertiesStrategy.getProperty(user, 'email')}</a></td>
